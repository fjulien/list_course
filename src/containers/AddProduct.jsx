...
import { addList, finalisation } from "../actions";
...
class AddProduct extends Component {
    ...
    commandeValid() {
        this.props.finalisation(this.props.list.filter(produit => produit.quantite > 0))
            ...
            <div className={this.props.displayCat ? "AddProductTrue" :"AddProductFalse"} onKeyPress={this.key}>
                ...
                <Row>
                    <Col sm='9'>
                        ...
                        <div className="elementIn">
                            <Link to='/'><Button color="secondary">Retour</Button></Link>
                        </div>
                    </Col>
                    <Col sm='1'>
                        <EasyTransition
...
function mdtp(dispatch) {
    return bindActionCreators({ addList, finalisation }, dispatch)
}
